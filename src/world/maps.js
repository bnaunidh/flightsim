...
export const MAPS = [
    ...
    waters: {
      roads: [
        ...
        },
        {
          halfWidth: 8,
          blend: 22,
          path: [[400, 24, 500], [400, 24, 700], [400, 24, 900], [400, 24, 1100], [400, 24, 1300], [400, 24, 1500]],
        },
        {
          halfWidth: 11,
          blend: 26,
        ...
        { halfWidth: 50, blend: 70, path: [[-30, 24, 1000], [30, 24, 1000]] },
      ],
    },
    palette: {
      grass: [1.02, 1, 0.82],
  ...
  /* desertrun — desertrun.map.js */
  {
    ...
    chunks: [
      { cx: 0, cz: 0, size: 15000, segments: 144 },
