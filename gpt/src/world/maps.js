...
export const MAPS = [
  {
    ...
    islands: [
      { name: 'Kestrel Island', cx: 0, cz: 0, radius: 2450, peak: 8, seed: 3, profile: 'plains' },
    ...
    waters: {
      roads: [
        ...
        },
        {
          halfWidth: 8,
          blend: 22,
          path: [[365.15, 500, 47.16], [369.35, 719.04, 41.2], [404.08, 934.68, 38.43], [451.13, 1144.14, 41.77], [485.86, 1345.73, 45.66], [490.05, 1539.16, 51.55]],
        },
        {
          halfWidth: 11,
          blend: 26,
        ...
        },
        {
          ...
          path: [
            ...
            [378.96, 1289.52, 42.4],
            [479.55, 1296.11, 43.73],
            [575.01, 1297.94, 45.3],
            [666.17, 1294.83, 52.24],
          ],
        },
        { halfWidth: 50, blend: 70, path: [[-33.64, 995.95, 45.3], [33.64, 1004.05, 44.69]] },
      ],
    },
    palette: {
      grass: [1.02, 1, 0.82],
  ...
  /* delta — delta-map.js, 450 m strip sited on Crane Spit, 0.6 m of levelling */
  {
    ...
    waters: {
      ...
      shoals: [
        ...
        { cx: -1100, cz: -3178, r: 592, top: -1.8, pow: 1.5 },
